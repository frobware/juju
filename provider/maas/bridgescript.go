...
# Modifies $configfile to enslave $primary_nic in $bridge.
#
# Non-zero return code indicates no modifications were made, due to
# not meeting one or more of the above conditions. Zero return means
# all modifications were completed successfully.
...
main() {
    ...
    # Bring up all aliases on the bridge.
